...
### 2.1 User Reality Today
Travel planning for international, multi-city trips is:
- Fragmented across YouTube, Instagram, Reddit, blogs, and booking sites
- Optimized for hype and popularity, not personal relevance
- Mentally exhausting and time-consuming
- Prone to critical blind spots such as route inefficiency, transport reliability, and attraction closures
...
None answer:
> “Given my vibe, what is the best way for me to experience this trip end-to-end?”
...
### 4.1 What TravelAI Is
- A decision-making layer, not a content browser
- An AI travel planner, not a listing platform
- A vibe-matching system, not a popularity engine
- A journey optimizer, not just a city recommender

### 4.2 What TravelAI Is Not
- A “Top 10 places” app
- A travel content aggregator
- A booking engine (for MVP)
- A manual itinerary builder
...
Principle: **User reacts. AI reasons.**
...
### Primary ICP
- International, multi-city travelers
- Research-heavy planners
- 7–20 day trips
- Experience-quality driven

### Out of Scope (MVP)
- Single-city weekend trips
- Last-minute planners
- “Just book and go” travelers

---

## 11. Failure Conditions
The product fails if:
- Users still double-check via YouTube or Google
- Recommendations feel generic
- Users cannot explain route logic
- Planning feels like work, not relief

---

## 12. Internal Alignment Rule

Reject any feature that:
- Improves metrics but hurts trust
- Adds flexibility but increases cognitive load
- Adds content without improving decisions

**The Product Contract always wins.**