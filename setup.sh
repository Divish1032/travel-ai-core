...
echo -e "   ${GREEN}python cli/crawl.py youtube --input data/sample_urls.txt --output local --limit 5${NC}"
echo ""
echo -e "${YELLOW}5. Check the results:${NC}"
echo -e "   ${GREEN}ls -lh data/raw/${NC}"
echo -e "   ${GREEN}python cli/crawl.py validate --input data/raw/youtube_batch_*.jsonl${NC}"
echo ""
...
echo -e "   ${GREEN}make jupyter${NC}                 - Start Jupyter Lab"
